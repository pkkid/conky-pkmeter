...
elements = {
  ...
  {kind='ring_graph', conky_value='fs_used_perc /home/mjs7231/Private', center={x=175, y=734}, radius=7, background_color=0xFFFFFF, background_alpha=0.1, background_thickness=5, bar_color=0xD79921, bar_thickness=4},
}
