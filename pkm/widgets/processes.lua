...
function processes:draw(origin)
  ...
  draw.text{x=10, y=origin+17, text='Processes', size=12, color=config.header} -- system
  draw.text{x=10, y=origin+32, text=utils.parse('processes')..' processes', color=config.subheader} -- hostname
